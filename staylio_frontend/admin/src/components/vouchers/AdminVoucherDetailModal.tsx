...
interface AdminVoucherDetailModalProps {
  voucher: VoucherResponse | null;
  onClose: () => void;
}

export default function AdminVoucherDetailModal({ voucher, onClose }: AdminVoucherDetailModalProps) {
                  ...
                  <div>
                    ...
                    {voucher.hotelBranchName && (
                      <div className="flex items-center gap-1.5 mt-2 text-sm text-gray-500">
                        ...
                        <span className="truncate font-medium text-gray-700" title={voucher.hotelBranchName}>
                          {voucher.hotelBranchName}
                        </span>
                      </div>
                    )}
