...
import { useCreateUtilityMutation } from "../../../../common/hooks/useUtilities";

interface UtilityFormAddProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function UtilityFormAdd({ isOpen, onClose }: UtilityFormAddProps) {
  ...
  const { mutateAsync } = useCreateUtilityMutation(formData);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gray-50/50">
          <h2 className="text-xl font-semibold text-gray-900">Thêm tiện ích mới</h2>
          <button
            type="button"
            onClick={handleClose}
          ...
          <div className="grid grid-cols-1 gap-y-2">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className={`w-full box-border px-4 py-3 border ${
