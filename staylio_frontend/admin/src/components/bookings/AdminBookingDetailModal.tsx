...
export default function AdminBookingDetailModal({ bookingId, onClose }: AdminBookingDetailModalProps) {
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            {booking?.paymentStatus === PaymentStatus.PAID && (
              <button
                onClick={() => handleOpenConfirm(BookingStatus.REFUNDED, "Hoàn tiền")}
                disabled={isUpdating}
                className="px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-xl hover:bg-purple-700 transition-colors disabled:opacity-50"
              >
                Hoàn tiền (Refund)
              </button>
            )}
