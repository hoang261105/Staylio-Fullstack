    ...
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12 w-full">
        ...
        <Link 
          ...
          className="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 transition-colors mb-8 font-medium"
        >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Đánh giá khách hàng</h1>
            <p className="text-gray-500">Phòng: <span className="font-semibold text-gray-700">{isLoadingRoom ? "Đang tải..." : room?.roomName}</span></p>
          </div>
          
          <div className="flex items-center gap-4 bg-gray-50 px-6 py-4 rounded-xl border border-gray-100">
            <div className="flex flex-col items-center">
              <span className="text-3xl font-black text-gray-900">{room?.averageRating?.toFixed(1) || "0.0"}</span>
              <span className="text-sm font-medium text-gray-500">/ 5 sao</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium text-gray-600">{room?.countReview || 0} bài đánh giá</span>
            </div>
          </div>
        </div>
        ...
        {isLoadingReviews ? (
           ...
           <div className="bg-white rounded-2xl p-16 text-center border border-gray-100 flex flex-col items-center">
             <MessageSquare className="w-12 h-12 text-gray-300 mb-4" />
             <h3 className="text-xl font-bold text-gray-900 mb-2">Chưa có đánh giá nào</h3>
             <p className="text-gray-500">Phòng này hiện chưa có lượt đánh giá nào từ khách hàng.</p>
           </div>
        ) : (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 text-lg">{review.fullName}</h4>
                ...
                <p className="text-gray-700 text-base leading-relaxed whitespace-pre-line mt-2">
                  {review.comment}
                </p>

                {review.replyComment && (
                  <div className="mt-6 bg-blue-50/70 rounded-xl p-5 border border-blue-100 relative before:content-[''] before:absolute before:-top-2 before:left-8 before:w-4 before:h-4 before:bg-blue-50/70 before:border-l before:border-t before:border-blue-100 before:rotate-45">
