  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-gray-900 font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 relative overflow-hidden">
        ...
        <div className="w-full max-w-[480px] bg-white dark:bg-gray-800 p-8 sm:p-10 rounded-3xl shadow-2xl shadow-gray-200/50 border border-gray-100 dark:border-gray-700 relative z-10">
          <RegisterForm 
              formData={formData} 
