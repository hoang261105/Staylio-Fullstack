      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-grow w-full flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-72 flex-shrink-0">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-28">
            ...
            <div className="mb-6">
              <label className="block text-sm font-semibold text-gray-700 mb-3">Đánh giá (Số sao)</label>
              <div className="flex items-center gap-2">
                <input
                  type="number"
                  placeholder="Min (0-5)"
        ...
        <div className="flex-1">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <button
                ...
                className="flex items-center justify-center p-3 rounded-xl bg-gray-50 border border-gray-200 hover:bg-gray-100 transition-colors text-gray-700"
          ...
          {isLoadingRooms ? (
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-16 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Không tìm thấy phòng</h3>
              <p className="text-gray-500">Không có phòng nào phù hợp với bộ lọc hiện tại của bạn. Vui lòng thử lại với các tiêu chí khác.</p>
            </div>
          ) : (
