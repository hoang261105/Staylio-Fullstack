          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-xl hover:bg-gray-100/70 transition group"
              >
                <div className="flex items-center gap-3 text-gray-500 group-hover:text-gray-800">
                  <Calendar size={20} />
              ...
              <div className="p-4 rounded-xl border border-gray-100 bg-gray-50 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Hết hạn 12/28</p>
                  </div>
                </div>

                <span className="text-xs font-semibold text-blue-600 bg-white px-2 py-1 rounded border border-gray-200 shadow-sm">
                  MẶC ĐỊNH
                </span>
              </div>
            </div>
