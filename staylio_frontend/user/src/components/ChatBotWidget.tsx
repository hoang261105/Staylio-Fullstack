...
export default function ChatBotWidget() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-6 right-6 w-full max-w-90 sm:max-w-100 bg-white rounded-3xl shadow-2xl border border-gray-100 z-100 overflow-hidden flex flex-col transition-all duration-500 origin-bottom-right ${isOpen
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-slate-50 space-y-4 scrollbar-thin scrollbar-thumb-gray-300">
          ...
          {messages.map((msg: ChatMessageResponse) => {
            ...
            return (
              ...
              >
                {!isUser && (
                  <div className="w-8 h-8 rounded-full bg-linear-to-br from-blue-100 to-indigo-100 flex items-center justify-center shrink-0 border border-blue-200">
        ...
        <div className="p-4 bg-white border-t border-gray-100">
          <form
            onSubmit={handleSend}
            className="flex items-center gap-2 bg-gray-50 p-1.5 rounded-2xl border border-gray-200 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100 transition-all"
          >
            <input
              type="text"
              value={inputValue}
              ...
              className="flex-1 bg-transparent px-3 py-2 text-sm focus:outline-none text-gray-800 disabled:opacity-50"
            />
            <button
              type="submit"
