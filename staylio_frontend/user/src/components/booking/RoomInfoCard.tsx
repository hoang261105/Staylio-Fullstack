...
export const RoomInfoCard = ({ room, branch }: RoomInfoCardProps) => {
    if (!room || !branch) return <div className="animate-pulse bg-gray-200 h-48 rounded-2xl"></div>;
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Chi tiết phòng</h2>
            <div className="flex gap-4">
                ...
                <div className="flex flex-col flex-1 min-w-0">
                    ...
                    <h3 className="font-bold text-gray-900 truncate" title={room.roomName}>
                        {room.roomName}
                    </h3>
                    <p className="text-sm font-medium text-gray-700 mt-1 truncate" title={branch.hotelBranchName}>
                    ...
                    <div className="flex items-center gap-1 mt-2">
                        ...
                        <span className="text-xs text-gray-500 ml-1">Tuyệt vời</span>
                    </div>
                </div>
            </div>
        </div>
