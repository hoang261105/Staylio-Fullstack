...
export const RoomInfoCard = ({ room, branch }: RoomInfoCardProps) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 mb-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Chi tiết phòng</h2>
            <div className="flex gap-4">
                ...
                <div className="flex flex-col flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-2">
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 ml-1">Tuyệt vời</span>
                    </div>
                </div>
            </div>
        </div>
