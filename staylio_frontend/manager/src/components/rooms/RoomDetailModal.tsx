import { X, MapPin, Tag, Users, Maximize, Bed, CheckCircle, XCircle, FileText, Info, Plus } from "lucide-react";
            ...
            <div className="w-full md:w-2/3 space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-50">
                  ...
                  <button className="flex items-center gap-1.5 text-sm font-medium text-[#0066FF] hover:text-[#0052CC] bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-lg transition-colors cursor-pointer">
